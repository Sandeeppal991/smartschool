    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        themeShadowBtn.addEventListener('click', function() {
            ...
            if (icon.classList.contains('fa-square')) {
                icon.classList.replace('fa-square', 'fa-layer-group');
            } else {
                icon.classList.replace('fa-layer-group', 'fa-square');
            }
        });
    });
</script>
...
<?php
 ...
 $('.event_to',__viewModal).data("DateTimePicker").date(event_end_to);
    ...
    $(document).ready(function () {
        // Use modern Moment API to avoid deprecated lang()/defineLocale warnings.
