    ...
    <div class="box border0">
        <ul class="tablists">
            ...
            <li class="<?php echo set_SubSubmenu('schsettings/googledrivesetting'); ?>">
                <a class="<?php echo set_SubSubmenu('schsettings/googledrivesetting'); ?>" href="<?php echo site_url('schsettings/googledrivesetting') ?>"><?php echo $this->lang->line('google_drive_setting'); ?></a>
            </li>
            ...
            <li class="<?php echo set_SubSubmenu('schsettings/chatsetting'); ?>">
                <a class="<?php echo set_SubSubmenu('schsettings/chatsetting'); ?>" href="<?php echo site_url('schsettings/chatsetting') ?>"><?php echo $this->lang->line('chat'); ?></a>
            </li>
            <?php } ?>
