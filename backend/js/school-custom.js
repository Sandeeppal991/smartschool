...
function modal_loader_div(){
    ...
    function safeModal(selector, actionOrOptions) {
        if ($.fn && typeof $.fn.modal === 'function') {
            return $(selector).modal(actionOrOptions);
        }
        return $(selector);
    }
 ...
 $(document).ready(function() {
      ...
      if ($.fn.modal) {
          safeModal('#sessionModal', {
              backdrop: 'static',
              keyboard: false,
              show: false
          });
          safeModal('#activelicmodal', {
              backdrop: false,
              keyboard: false,
              show: false
          });
